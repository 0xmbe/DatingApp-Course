...
public class AccountController(DataContext context, ITokenService tokenService) : BaseApiController
{
    ...
    {
        var user = await context.Users.FirstOrDefaultAsync(x => x.UserName == deleteDto.Username.ToLower());
        ...
        // Generate password hash
        using var hmac = new HMACSHA512(user.PasswordSalt);
        var ComputeHash = hmac.ComputeHash(Encoding.UTF8.GetBytes(deleteDto.Password));
        ...
        return "User " + deleteDto.Username + " deleted";
    }
